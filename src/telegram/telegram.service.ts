...
const DEFAULT_GLOBAL_MEMORIES = [
  ...
  },
  {
    ...
    text:
      'Правило цинцкарского языка — множественное число существительных. ' +
      'Существительные не имеют рода; у них есть единственное и множественное число, а также падежи. ' +
      'После мягких гласных основы â, e, и, û, ô, ŷ используется аффикс -лâр: Âв → Âвлâр, Ер → Ерлâр, Âми → Âмилâр, Ŷрач → Ŷрачлâр. ' +
      'После твёрдых гласных основы а, и, о используется аффикс -лар: Ана → Аналар, Чам → Чамлар, Ушах → Ушахлар, Топ → Топлар. ' +
      'Другие примеры: Гхари → гхарылар, Даи → даûлар, Джêчи → джêчылâр. ' +
      'Если слово заканчивается на л, н или т, последняя согласная удваивается, а окончание принимает вид -ар или -âр: Нал → наллар, Ат → аттар, Торун → торуннар, Чапут → чапуттар. ' +
      'Если слово заканчивается на и, во множественном числе она переходит в û или ы. ' +
      'Если перед существительным стоит числительное, аффиксы -лâр и -лар не ставятся: ичи âв, он адам, беш алма, он алтû кампет.',
  },
] as const;
