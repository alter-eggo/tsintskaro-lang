...
- `/startreview` — start or resume delivery in this topic. On first start, send the first batch immediately and anchor the schedule to today's Tbilisi date. Starting on September 13 schedules September 16, 19, 22, etc. at 09:00.
